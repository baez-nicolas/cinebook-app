...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/cinemas/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/showtimes/**").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/bookings/upcoming").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/bookings/history").hasAnyRole("USER", "ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
            "http://localhost:4200",
            "https://natural-curiosity-production-c1bb.up.railway.app"
        ));
